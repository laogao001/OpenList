...
// @connect      127.0.0.1
// @license MIT
// @downloadURL  https://raw.githubusercontent.com/laogao001/OpenList/main/embyToLocalPlayer.user.js
// @updateURL    https://raw.githubusercontent.com/laogao001/OpenList/main/embyToLocalPlayer.user.js
// ==/UserScript==
'use strict';
/*global ApiClient*/
...
(function () {
    ...
    function playNotifiy(title = '正在播放', subtitle = '开始享受您的内容') {
        ...
        document.querySelectorAll('.etlp-notification').forEach(el => el.remove());

        const notification = document.createElement('div');
        notification.className = 'etlp-notification';
